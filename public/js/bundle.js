        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              // TODO dev/prod url: '/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://localhost:8000/api/v1/users/logout' // TODO dev/prod url: '/api/v1/users/logout'
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW5qZWtvdmEiLCJhIjoiY2s3eWliNDdrMDJjdDNmcDk1d2NycnVmYiJ9.cXxRFgU5GI4p9jpKPzLIVw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend map bounds to incldue current location
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " changed successful."));
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_gwAYLO0F0tRO71NdjR4tKnAy00tXhBkK1S');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:8000/api/v1/bookings/checkout-session/".concat(tourId) // TODO dev/prod `/api/v1/bookings/checkout-session/${tourId}`
            );
...
var dataUpdateForm = document.querySelector('.form-user-data');
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.bnt--save-password').innerHTML = 'SAVING PASSWORD...';
